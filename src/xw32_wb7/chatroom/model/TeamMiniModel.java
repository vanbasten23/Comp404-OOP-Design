...
public class TeamMiniModel {
	...
	/**
	 * Send a text message
	 * @param str The text message to be sent.
	 */
	...
	/**
	 * get the local client member stub
	 * @return Client member stub.
	 */
	...
	/**
	 * put all the commands into the visitor.
	 */
