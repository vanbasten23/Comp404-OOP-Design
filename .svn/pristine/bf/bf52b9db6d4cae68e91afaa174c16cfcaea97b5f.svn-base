...
public abstract class ClassServer implements Runnable {
	...
	/**
	 * TCP Socket being used by server
	 */
	 ...
	 * @param path full classpath of desired class
	...
	/**
	 * Stops the class server if true.
	 */
	private volatile boolean isStop = false;
	/**
	 * Asynchronously stops the class server 
	 */
	public void stop(){
		isStop = true;
		try {
	...
	public void run()
	{
		...
		try {
			...
			System.out.println("ClassServer.run(): Request received from IP address = "+socket.getInetAddress());
	 ...
	 * @return full classpath of requested class file
	 * @throws IOException If cannot read class name from input
	 */
